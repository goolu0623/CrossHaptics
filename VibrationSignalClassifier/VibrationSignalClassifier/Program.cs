...
namespace vibration_signal_classifier {
    ...
    class Program {
        ...
        private static Thread subThread = new Thread(SubscribeThread);
            ...
            while (true) {
                ...
                while (eventList.Count() != 0) {
                    ...
                    if (IsSymmetric()) {
                        ...
                        symmetrical_event_publisher.Publish("nonsymmetrical_event", nowEvent.ToString()); // 要publish什麼是隨便填的 之後再補
                    }
                    else {
                        ...
                        nonsymmetrical_event_publisher.Publish("symmetrical_event", nowEvent.ToString()); // 要publish什麼是隨便填的 之後再補
                    }
