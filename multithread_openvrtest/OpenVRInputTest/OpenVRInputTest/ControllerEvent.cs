...
namespace OpenVRInputTest {
    ...
    public abstract class ControllerEvent {
        ...
        public bool DigitalFetchEventResult(ref Queue<Tuple<string,string>> output_data) {
            ...
            // Result
            if (Digital.bChanged) {
                VREventCallback.NewDigitalEvent(controller.ControllerType, (DigitalControllerEvent)this, Digital.bState, ref output_data);
            }
            return Digital.bState;
        }
        public InputAnalogActionData_t AnalogFetchEventResult(ref Queue<Tuple<string,string>> output_data) {
            ...
            if (Analog.deltaX != 0 || Analog.deltaY != 0 || Analog.deltaZ != 0) {
                VREventCallback.NewAnalogEvent(controller.ControllerType, (AnalogControllerEvent)this, Analog, ref output_data);
            }
            return Analog;
        }
        public InputPoseActionData_t PoseFetchEventResult(ref Queue<Tuple<string,string>> output_data) {
            ...
            if (Pose.pose.bDeviceIsConnected == true && Pose.pose.bPoseIsValid == true) {
                ...
                VREventCallback.NewPoseEvent(controller.ControllerType, (PoseControllerEvent)this, position, quaternion, ref output_data);
            }
            return Pose;
        }
    }
